...
public class QuestionHandler { // The QuestionHandler class is used to allow a program to easily access and use Questions and Answers which are stored in a textfile
	...
	private String fileName = "questions.txt";//"short.txt"; //short.txt is a text file that was used for debugging it contains only 3 questions, also it should be noted after the last answer to the last question in the text file there should be no spaces or new line "\n" characters or an error can occur.
